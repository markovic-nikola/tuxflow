...
- `tuxflow-agent-symbolic.svg` (a robot head: antenna, two eyes, mouth, ears — solid shapes only; a brain, outlined or filled, was a blob at the caption's 11 px) marks the agents group. GTK asked the
