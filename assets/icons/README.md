...
- `tuxflow-agent-symbolic.svg` (a brain: two filled lobes with the folds cut out even-odd — an outline turned to mush at the caption's 11 px) marks the agents group. GTK asked the
